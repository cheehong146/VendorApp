...
public class CONSTANTS {
    public final static String INFO_LOADING = "Loading...";
    public final static String PROMOTION_DETAIL_FRAGMENT = "PromotionDetailFragment";
    public final static String HOME_PARENT_FRAGMENT = "HomeParentFragment";
    ...
    public final static String VOUCHER_FRAGMENT = "VoucherFragment";
}
